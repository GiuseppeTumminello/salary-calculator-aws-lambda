...
RECEIVE_MESSAGE_QUEUE_URL = SQS.get_queue_url(QueueName='disability-zus-queue').get('QueueUrl')


def send_message_to_queue(self):
    SQS.send_message(QueueUrl=SEND_MESSAGE_QUEUE_URL, MessageBody=str(self))
